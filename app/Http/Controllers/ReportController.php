...
class ReportController extends Controller
{
    ...
    public function neraca(Request $request)
    {
        ...
        // dd($ppn_keluaran);
        // dd('hutang Pajak : '.$hutang_pajak. ', hutang pajak awal : '.$hutang_pajak_awal.' ppn keluaran : '.$ppn_keluaran);
        ...
        $data['hutang_pajak'] = number_format(round($hutang_pajak-$hutang_pajak_awal+$ppn_keluaran-$ppn_masukan), 2, ".", "");
